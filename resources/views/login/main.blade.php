        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                ...
                <span class="text-white text-lg ml-3">
                    QT<span class="font-medium">our</span>
                </span>
            </a>
            <div class="my-auto">
                ...
                <div class="-intro-x mt-5 text-lg text-white dark:text-gray-500">Manage all your e-commerce accounts in
                    one place</div>
            </div>
        </div>
        <!-- END: Login Info -->
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div
                ...
                <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                    By signin up, you agree to our <br> <a class="text-theme-1 dark:text-theme-10" href="">Terms and
