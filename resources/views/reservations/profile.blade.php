        ...
        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
            ...
            <div class="ml-5">
                <div class="w-24 sm:w-40 truncate sm:whitespace-normal font-medium text-lg">
                    John Cash Myer's Group</div>
                <div class="text-gray-600">H8U83JIDJ9</div>
            </div>
        </div>
        <div
            ...
            <div class="truncate sm:whitespace-normal flex items-center">
                <i data-feather="mail" class="w-4 h-4 mr-2"></i> 12/12/2020 - 12/12/2020
            </div>
            <div class="truncate sm:whitespace-normal flex items-center mt-3">
                <i data-feather="instagram" class="w-4 h-4 mr-2"></i> 12 Visiting Members
            </div>
            <div class="truncate sm:whitespace-normal flex items-center mt-3">
                <i data-feather="twitter" class="w-4 h-4 mr-2"></i>Shadhil Athumani Kimbama
            </div>
        </div>
        <div
            ...
            <div class="text-center rounded-md w-20 py-3">
                <div class="font-semibold text-theme-1 dark:text-theme-10 text-lg">2</div>
                <div class="text-gray-600">Day(s)</div>
            </div>
            <div class="text-center rounded-md w-20 py-3">
                <div class="font-semibold text-theme-1 dark:text-theme-10 text-lg">1</div>
